...
// Add grocery/produce items with real store barcode numbers
// S = sold by scale (per lb), Q = sold by quantity (each)
const GROCERY_ITEMS = [
  // ─── PRODUCE (from store binder, pages 1-5) ──────────
  ...
  {id:519,barcode:'222',name:'Banana Verde (lb)',price:0.79,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:520,barcode:'223',name:'Banana Amarilla (lb)',price:0.69,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:521,barcode:'223B',name:'Batata / Camote (lb)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:522,barcode:'224',name:'Manzana Roja / Apple Red (each)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:523,barcode:'225',name:'Manzana Verde (each)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:524,barcode:'226',name:'Mandarina (each)',price:0.50,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:525,barcode:'227',name:'Naranjas Grande (each)',price:0.79,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:526,barcode:'229',name:'Chile Poblano Fresco (lb)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:527,barcode:'231',name:'Aullama / Calabaza (lb)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:528,barcode:'232',name:'Cana / Cane (each)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:529,barcode:'233',name:'Melon Cantaloupe (each)',price:2.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:530,barcode:'234',name:'Zanahoria / Carrots Per Pound (lb)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:531,barcode:'235',name:'Cebollin / Cambray (bunch)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:532,barcode:'236',name:'Celery (each)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:533,barcode:'237',name:'Granada / Pomegranate (each)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:534,barcode:'238',name:'Cilantro (bunch)',price:0.79,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:535,barcode:'240',name:'Jicama (lb)',price:1.29,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:536,barcode:'241',name:'Lechoza / Papaya (lb)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:537,barcode:'243',name:'Lime / Limon Verde (each)',price:0.25,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:538,barcode:'244',name:'Maiz Mazorca / Elote (each)',price:0.79,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:539,barcode:'245',name:'Mango Bola (each)',price:1.29,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:540,barcode:'246',name:'Mango Mexicano (each)',price:1.29,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:541,barcode:'247',name:'Eggplant / Berenjena (lb)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:542,barcode:'248',name:'Pepper Bell / Pimiento Verde (lb)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:543,barcode:'249',name:'Pina / Pineapple (each)',price:3.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:544,barcode:'251',name:'Platano Verde (each)',price:0.50,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:545,barcode:'252',name:'Rabano / Radish (bunch)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:546,barcode:'253',name:'Watermelon / Sandia (each)',price:5.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:547,barcode:'254',name:'Chayote / Tayota (lb)',price:1.29,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:548,barcode:'255',name:'Chayote Espino (lb)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:549,barcode:'256',name:'Uvas Rojas / Grapes Red (lb)',price:2.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:550,barcode:'257',name:'Uva Verde / Grapes Green (each)',price:2.49,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:551,barcode:'258',name:'Yuca (lb)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:552,barcode:'259',name:'Durazno / Peach Nectarine (lb)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:553,barcode:'260',name:'Pepper Red (lb)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:554,barcode:'261',name:'Limon Amarillo (each)',price:0.50,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:555,barcode:'262',name:'Chile Guajillo Seco (lb)',price:7.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:556,barcode:'263',name:'Tamarindo (lb)',price:2.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:557,barcode:'264',name:'Chile Morita Seco (lb)',price:6.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:558,barcode:'265',name:'Flor De Jamaica (lb)',price:5.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:559,barcode:'266',name:'Chile Arbol Seco (lb)',price:8.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:560,barcode:'267',name:'Chile Ancho Seco (lb)',price:7.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:561,barcode:'270',name:'Ginger / Jengibre (lb)',price:3.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:562,barcode:'271',name:'Epazote (bunch)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:563,barcode:'272',name:'Tuna Fruta (each)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:564,barcode:'274',name:'Guayaba Fresca (lb)',price:2.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:565,barcode:'275',name:'Mamey (lb)',price:3.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:566,barcode:'276',name:'Plum / Ciruela (lb)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:567,barcode:'277',name:'Pera / Pear (each)',price:0.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:568,barcode:'279',name:'Culantro (bunch)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:569,barcode:'280',name:'Savila / Aloe Vera (each)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
  {id:570,barcode:'281',name:'Apricot (lb)',price:2.49,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:571,barcode:'283',name:'Yautia / Lila (lb)',price:1.99,is_taxable:0,is_ebt_eligible:1,sell_by:'S'},
  {id:572,barcode:'284',name:'Chinola (each)',price:1.49,is_taxable:0,is_ebt_eligible:1,sell_by:'Q'},
